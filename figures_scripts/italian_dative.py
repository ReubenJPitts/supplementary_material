...
"""
Output: Figure italian_dative.png
Used in: Chapter 6
...
# import dataset
data = pd.read_csv("datasets_automatic/order_dative.csv", sep=";", index_col=0)
...
### 3 ### Save the plot
plt.savefig('figures/italian_dative.png', bbox_inches='tight', dpi=600)
