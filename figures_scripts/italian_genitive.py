...
# create two plots
add_to_ax(umbrian,ax3,"Latin genitives")
umbrian = umbrian[umbrian["Meaning_category"] != "PROPER"]
add_to_ax(umbrian,ax6,"Latin non-proper genitives")


### 3 ### Save the plot
plt.savefig('figures/italian_genitive.png', bbox_inches='tight', dpi=600)
